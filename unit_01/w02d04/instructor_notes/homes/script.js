...
newHomes.forEach(function(home) {
  var homeInfoRowHTML = "<tr><td>" + home.address + "<td></td>" + home.sf + "<td></td>" + home.price
 + "<td></td>" + home.bedrooms + "<td></td>" + home.baths + "<td></td>" + home.price + "</td>"
 var $homeInfoRowObject = $(homeInforowHTML);
 $('#homes ibody').append($homeInfoRowObject);
});
